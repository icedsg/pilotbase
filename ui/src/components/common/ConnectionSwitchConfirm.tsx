...
export default function ConnectionSwitchConfirm({ onCancel, onConfirm, onConfirmDontAskAgain }: Props) {
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-surface-100 border border-surface-50 rounded-xl shadow-2xl p-6 w-[420px] max-w-[90vw]">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Switch database connection?</h2>
        </div>

        <p className="text-xs text-gray-500 dark:text-gray-400 mb-5 leading-relaxed">
          You have an unsaved query, results, or AI agent chat open. Switching connections will clear them and
          start a new AI agent chat for the newly selected connection.
        </p>
